...
namespace ATG.StateMachine
{
	...
	{
		private readonly List<Statement> _statemens;
		...
		public StateMachine (params Statement[] statements)
		{
			_statemens = new List<Statement>(statements);
		}
		...
		{
			_statemens.AddRange (statements);
		}
